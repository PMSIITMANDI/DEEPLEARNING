...
designed_model.load_weights('/home/mahesh/PycharmProjects/hello/lineset2-03-0.0170.hdf5')
...
print("Length_Accuracy:", scores[5])
print("Width_Accuracy:", scores[6])
print("Angle_Accuracy :", scores[7])
print("Color_Accuracy:", scores[8])
