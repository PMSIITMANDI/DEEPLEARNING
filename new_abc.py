...
X_train, X_test, y_train_cat, y_test_cat, gt_train, gt_test = train_test_split(image,cat, list, test_size=0.25, random_state=42)
...
localisation_model.compile(optimizer='nadam', loss=losses, loss_weights=lossWeights,
	metrics=["accuracy"])
# train the network to perform multi-output classification
localisation_model.summary()
localisation_model.fit(X_train,
	{"class_output": y_train_cat,"reg_output":gt_train},
